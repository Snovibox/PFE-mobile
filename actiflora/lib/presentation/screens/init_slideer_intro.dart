                ...
                child: Column(
                  children: [
                    ...
                    Center(child: TextButton(
                      ...
                      child: Text('Next >', style: TextStyle(color : myGreen),),
...
class Item extends StatelessWidget {
  ...
  TextButton getButton(BuildContext context, String target, String x){
    if(target==x) {
      return TextButton(
        onPressed: () {
          Navigator.push(
        ...
        child: TextFormatWidget.TextIntroBtn(data[language]["start"]),
      );
    }
    return TextButton(
      onPressed: () => controller.nextPage(),
      child: TextFormatWidget.TextIntroBtn(data[language]["next"]+' >'),
    );
  }
          ...
          Container(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                Flexible(
                  child: getButton(context, 'last', item.description),
                ),
              ],
            ),
          ),
